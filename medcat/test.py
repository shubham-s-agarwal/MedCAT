...
mc.config.train.class_weights = [0.35, 0.65]
mc.config.train.metric['base'] = 'macro avg'
mc.config.model.model_freeze_layers = False

mc.config.model['num_layers'] = 5
mc.config.general[ "category_value2id"] = {"Confirmed": 0,"Other": 1}

mc.config.train['loss_function'] = 'focal_loss'

model_arch_config = {'fc2': True, 'fc3': True,'lr_scheduler': True}
